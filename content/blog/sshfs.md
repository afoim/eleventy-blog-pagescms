...
draft: false
coverImage: /public/img/sshfs-Linux-win.png
---
...
![](/public/img/sshfs-sshfs.png)

![](/public/img/sshfs-sshfs-1.png)

同时，我们也可以使用任何软件来直接打开Linux上的文件来远程开发

![](/public/img/sshfs-sshfs-2.png)
