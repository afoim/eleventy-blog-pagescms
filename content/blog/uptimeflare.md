...
这迁移到D1何意味
![](/public/img/uptimeflare-uptimeflare-16.webp)
...
![](/public/img/uptimeflare-uptimeflare-1.webp)

![](/public/img/uptimeflare-uptimeflare-14.webp)
...
![](/public/img/uptimeflare-uptimeflare-4.webp)

最后，来到 `Action` 页面，手动创建一个 `Deploy to Cloudflare` 的工作流
![](/public/img/uptimeflare-uptimeflare-5.webp)

等待工作流运行结束，你应该可以在Cloudflare仪表板看见一个新的Page，新的Worker和新的D1
![](/public/img/uptimeflare-uptimeflare-6.webp)


点开 Page，注意不要点错了
![](/public/img/uptimeflare-uptimeflare-8.webp)

绑定你的域名，尝试访问
![](/public/img/uptimeflare-uptimeflare-9.webp)

如果你能看到一个初始的监控页面，则正常
![](/public/img/uptimeflare-uptimeflare-10.webp)
...
添加一个域名（作为你的发信域名）
![](/public/img/uptimeflare-uptimeflare-11.webp)

创建一个发信API Key
![](/public/img/uptimeflare-uptimeflare-12.webp)

添加环境变量： `RESEND_API_KEY` 将其绑定到 **Action**

![](/public/img/uptimeflare-uptimeflare-13.webp)
...
![](/public/img/uptimeflare-1dc1a98a404db83e909c1f87e8a115cf.webp)
