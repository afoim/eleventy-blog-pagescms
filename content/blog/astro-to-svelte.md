...
draft: false
tags: []
coverImage: /public/img/astro-to-svelte-svelte.png
---
# 为什么要重构为纯Svelte？
...
![](/public/img/astro-to-svelte-Pasted-image-20260424182832.png)
...
![](/public/img/astro-to-svelte-index-5.png)
...
![](/public/img/astro-to-svelte-index-3.png)

而这些功能无一例外都是 **Svelte** 。这更代表了整个项目已经被 Svelte 架空了，那么，不如贯彻到底，直接把Astro丢了吧？

![](/public/img/astro-to-svelte-index-4.png)
...
![](/public/img/astro-to-svelte-index-11.png)
...
![](/public/img/astro-to-svelte-index-7.png)

而新站，开启增量图片压缩后也仅需1分钟左右

![](/public/img/astro-to-svelte-index-8.png)

再接下来，是重定向。由于SvelteKit并不像Astro一样支持直接在类似 `astro.config.mjs` 里配置静态重定向

![](/public/img/astro-to-svelte-index-9.png)

不过这也是个好处，我们可以自己写一个Vite插件来创建静态重定向，并自定义重定向页面

![](/public/img/astro-to-svelte-index-10.png)
...
![](/public/img/astro-to-svelte-index-12.png)
