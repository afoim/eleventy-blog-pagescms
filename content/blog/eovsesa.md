...
![](/public/img/eovsesa-eovsesa-1.webp)

# 规则引擎与WAF

ESA的很多东西直接是照抄Cloudflare的，比如：

![](/public/img/eovsesa-eovsesa-3.webp)

![](/public/img/eovsesa-eovsesa-2.webp)

并且还将每条规则（嵌套子规则也算一条）全部砍了一刀，免费套餐仅支持5条规则。

![](/public/img/eovsesa-eovsesa-4.webp)

## EdgeOne 的优势

反观EdgeOne，它没有照抄Cloudflare，而是自己写了一套规则引擎，所有类型的规则都在一处地方配置，并且可以互相联动。

![](/public/img/eovsesa-eovsesa-5.webp)

![](/public/img/eovsesa-eovsesa-6.webp)

甚至你还可以对不合法请求在L7给空。（不推荐，规则引擎的假拦截也算正常请求）
![](/public/img/eovsesa-1f63e461bfa538605c7734042edd68f6.webp)

![](/public/img/eovsesa-eovsesa-7.webp)

![](/public/img/eovsesa-eovsesa-8.webp)
...
![](/public/img/eovsesa-eovsesa-17.webp)

![](/public/img/eovsesa-eovsesa-18.webp)

那么也没有什么让Page吃上CDN规则的方法呢？有的，兄弟有的（但是这样会在控制台看到双倍流量，如果你的Page纯静态，可以写个全缓存缓解一下）。

![](/public/img/eovsesa-eovsesa-19.webp)
