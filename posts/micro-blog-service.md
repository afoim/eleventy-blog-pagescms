...
2. 域名变更风险：如果说我们后续的 2叉点 NZ 这个域名它不再继续使用了，我们还需要再更改一遍，更改为之后的域名。
...
最后，我们需要做一个收尾工作：如果之前有其他网站刊登了我的文章，它用的还是 pathname，我们需要通过 Cloudflare 的静态或者动态重定向去写一条简单的规则，让它重定向到我们新的 query 的形式。
